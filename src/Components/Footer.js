                            ...
                            <div className="col-lg-4 col-md-6 col-sm-6">
                                <div className="mb-30">
                                    ...
                                    <div className="footer-info-contact"><i class="bi bi-phone"></i>
                                        <h3>Phone</h3><span>+91-734-7230-733</span></div>
                                    <div className="footer-info-contact">
                                        {/* <i className="flaticon-envelope"></i> */}
                                        <i class="bi bi-envelope-open"></i>
                                        <h3>Email</h3><span>hr@ducktaleit.com</span></div>
                                    <div className="footer-info-contact">
                                        {/* <i className="flaticon-placeholder-filled-point"></i> */}
                                        <i class="bi bi-geo-alt-fill"></i>
                                        <h3>Address</h3><span>IT Tower, E261-3rd Floor, NH5, Industrial Area, Sector 74,
                                            Sahibzada Ajit Singh Nagar, Punjab 140308. India</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
