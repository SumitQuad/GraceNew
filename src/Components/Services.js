                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="single-services-box">
                                ...
                                <p>We, at DuckTale IT Services Pvt. Ltd. leverage the Hybrid Application Development for your enterprises.</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="single-services-box">
                                ...
                                <p>We, at DuckTale IT Services Pvt. Ltd., are a leading .NET Application Development Company.</p>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col-sm-6">
                            <div className="single-services-box">
