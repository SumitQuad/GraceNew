                    ...
                    <div className="row align-items-center">
                        <div className="col-lg-5 col-md-12">
                            <div className="features-content-area">
                                ...
                                <p>DuckTale IT servies Provide realistc, customized solutions and consultation support for Web Applications/Softwares, Mobile Applications and Digital Marketing.</p>
